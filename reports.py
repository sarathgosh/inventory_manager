...
def create_excel_report(
    ...
    for column_index, header in enumerate(headers, 1):
        ...
        elif "Quantity" in header or header in {"Reorder Level", "Total Test Effective"}:
            for row in range(2, data_sheet.max_row + 1):
...
def create_import_template() -> bytes:
    ...
    instructions["A4"] = "Optional code"
    instructions["B4"] = "Leave Inventory Code blank and the app will create one."
    instructions["A5"] = "Dates"
    instructions["B5"] = "Use YYYY-MM-DD or DD-MM-YYYY."
    instructions["A6"] = "Replace mode"
    instructions["B6"] = "Creates a new inventory list after confirmation; make a backup first."
